...
public class DeplacementState extends BasicGameState
{
	...
	private boolean zoneCombat = false ;
	...
	public void keyPressed(int key, char c)
	{
		...
		case Input.KEY_F2:
			...
			break;
		case Input.KEY_A:
			this.zoneCombat = !this.zoneCombat ;
			break;
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException
	{
		...
		if(this.zoneCombat)
		{
			g.setColor((new Color((float)0.8, 0, 0, .4f)));
			g.fillRoundRect(
					this.obtenirPositionCaseParCase(
							this.obtenirPositionCaseRelative(this.joueur.x,this.joueur.y).X,
							this.obtenirPositionCaseRelative(this.joueur.x,this.joueur.y).Y).X - 64,

							this.obtenirPositionCaseParCase(
									this.obtenirPositionCaseRelative(this.joueur.x,this.joueur.y).X,
									this.obtenirPositionCaseRelative(this.joueur.x,this.joueur.y).Y).Y - 64,
									128, 128, 5);
		}
